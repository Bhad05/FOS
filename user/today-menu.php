	...
	<div class="container-fluid">
		<ul class="nav" style="height: 100px; background-color: #001a33;">
			<li class="nav-item col-md-9 col-lg-10" style="margin-top: 45px;">
				...
				<h4 style="font-weight: bolder; font-family: 'Trebuchet MS', Helvetica, sans-serif";><a href="today-menu.php" style="color: white;" class="nav-link"><img src="../imgs/burger.png" style="margin-top: -10px;"> What are you eating today ?</a></h4>
			</li>
		...
		<div class="row">
			<div class="col-xs-2 col-md-3 col-lg-3" id="nav_column">
			<nav class="navbar">
				<ul class="navbar-nav w-100" style="margin-top: 80px;">
					<li class="nav-item"> 
						<a href="today-menu.php" class="nav-link"><img src="../imgs/order.png"> LUNCH MENU </a>
					</li>
					<li class="nav-item">
		...
		<div class="col-xs-10 col-md-8 col-lg-8">
			...
			<div class="row p-5">
				<div class="col-lg-11" style="margin-top: 40px; border-bottom: 1px solid gray; ">
